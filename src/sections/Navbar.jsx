      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-black/90 ">
        <div className="max-w-7xl mx-auto">
          <div className="flex justify-between items-center py-5 mx-auto c-space ">
            <a
              href="/" className="text-neutral-400 text-xl hover:text-white transition-colors"
            >
              Praveen
            </a>
            ...
            <nav className="sm:flex hidden items-center justify-end gap-4 text-neutral-400 hover:text-white transition-colors">
                <NavItems/>
